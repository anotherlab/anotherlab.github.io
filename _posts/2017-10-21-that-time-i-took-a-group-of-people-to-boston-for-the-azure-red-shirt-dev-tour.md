...
He then spent another hour on Azure Containers and Azure Functions. All good stuff. I was familiar with the concept of [Azure Functions](https://azure.microsoft.com/en-us/services/functions/), but it had never really clicked with me before on how useful they could be. Go watch the recording of [Red Shirt Dev Tour in NYC on Channel 9](https://channel9.msdn.com/Events/Microsoft-Azure/Azure-Red-Shirt-Dev-Tour-NYC-2017). Scott and his minions covered a lot of cool things.
