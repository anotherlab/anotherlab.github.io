var store = [{
        ...
        "excerpt":"&lt;/div&gt; A recent post on Twitter by Brad Sams asks the question What would you do to revive Windows Phone? — Brad Sams (@bdsams) January 29, 2016 That tweet has been getting a few responses and it&#8217;s been a trendy topic of late. Between newly blond Joe Belfoire tweeting from an...","categories": [],
        "tags": [],
        ...
        "excerpt":"iPhone 5C, FBI Edition There has been a lot of conversations about the court order that the FBI has filed on Apple.  If you are following this story and have not yet read the court order, you should read it now. The FBI is asking for Apple to disable the...","categories": [],
        "tags": [],
        "url": "/2016/02/18/fbi-vs-apple-vs-the-consequences/",
        "teaser": null
      },{
        "title": "Generating new row numbers in SQL based on a starting value",
        "excerpt":"Embed from Getty Images &lt;/div&gt; One of our support people came to me with an interesting task.  He needed to add rows from a SQL Server table to another table and populate a row number type of field.  That field needed to be generated by his SQL statements and start with...","categories": [],
        "tags": [],
        ...
        "excerpt":"Embed from Getty Images &lt;/div&gt; I just updated this blog to use the Accelerated Mobile Pages (AMP) plugin for WordPress.  AMP is an open source project designed to optimize page content for mobile pages.  It uses a subset of HTML and some JavaScript to trim down the content of a...","categories": [],
        "tags": [],
        ...
        "excerpt":"Embed from Getty Images &lt;/div&gt; My wife and I both have Sony mirrorless cameras. She has an Alpha 5000 and I have a NEX-6. I back up all of our images to my home dev box, and then to a QNAP NAS server. The images are stored in folders based...","categories": [],
        "tags": [],
        ...
        "excerpt":"Embed from Getty Images &lt;/div&gt; A couple of weeks ago my blog was defaced through a security hole in WordPress. About 800,000 blogs were hit via something called the REST-API exploit. I saw something like this on the main page of my blog Hacked message I blurred out the identifying...","categories": ["WordPress"],
        "tags": ["WordPress"],
        "url": "/2017/02/21/and-then-my-blog-was-defaced/",
        "teaser": null
      },{
        "title": "A Xamarin port of the usb-serial-for-android library",
        "excerpt":"Back in January, I ported the excellent usb-serial-for-android library from the Java source code to Xamarin C#.  We have an Android application that needs to use an external RFID reader.  The reader is an Elatec TWN4 RFID reader and it can work as virtual comm port over USB. To use...","categories": ["Uncategorized"],
        "tags": [],
